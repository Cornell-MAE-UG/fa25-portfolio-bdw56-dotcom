...
![Photo of diagram]({{ "/assets/images/Heat Exchanger Drawing.jpg" | relative_url }}){: width="200px"}

![Parallel flow]({{ "/assets/images/parallel-flow.jpeg" | relative_url }}){: width="200px"}
![Counter flow]({{ "/assets/images/counter-flow.jpeg" | relative_url }}){: width="200px"}
...
![Photo of control volume explanation]({{ "/assets/images/CV-explanation.jpeg" | relative_url }}){: width="200px"}

![Photo of data]({{ "/assets/images/Heat-exchanger-data.jpeg" | relative_url }}){: width="200px"}
