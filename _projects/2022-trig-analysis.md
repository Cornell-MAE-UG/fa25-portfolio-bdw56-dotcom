...
In every instance, the change of temperature of the hot flow was greater in magntiude than that of the cold flow.
In both parallel pump speeds, the hot flow final tmeperature was  hotter than that of the cold flow; however, in both counterflow instances, the cold flow final temperature was greater than that of the hotter flow.