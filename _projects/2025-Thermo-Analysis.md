...
![Photo of diagram]({{ "/assets/images/Heat Exchanger Drawing.jpg" | relative_url }}){: width="575px"}
...
![Photo of control volume explanation]({{ "/assets/images/CV-explanation.jpeg" | relative_url }}){: width="400px"}

![Photo of data]({{ "/assets/images/Heat-exchanger-data.jpeg" | relative_url }}){: width="400px"}
